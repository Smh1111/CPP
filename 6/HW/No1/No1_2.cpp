...
int main()
{
    ...
    // test to get a list of books that match specific genre from a collection 
    vector<Book> result = b1.find_books_byGenre(books, Genre::fiction);
